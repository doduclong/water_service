            ...
            <div class="card">
                <div class="card-body">
                    <form action="signup" method="post">
                        ...
                        <button type="submit" class="btn btn-success w-100 mb-1">Đăng ký</button>
                        <a href="/WaterServiceApplication/login.jsp"><button type="button" class="btn btn-light w-100">Đăng nhập</button></a>
                    </form>
                </div>
            </div>
        </div>
