                ...
                <div class="card-body">
                    <form action="login" method="post">
                        ...
                        <fieldset class="form-group">
                            ...
                            <input type="text" value="${username}" class="form-control" name="username" autocomplete="off" autofocus required="required" oninvalid="this.setCuutocomplete="offstomValidity('Trường này không được để trống.')" oninput="setCustomValidity('')">
                        </fieldset>
                        ...
                        <button type="submit" class="btn btn-success w-100 mb-1">Đăng nhập</button>
                        <a href="/WaterServiceApplication/signup.jsp"><button type="button" class="btn btn-light w-100">Đăng ký</button></a>
                    </form>
                </div>
            </div>
        </div>
